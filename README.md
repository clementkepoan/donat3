...
2. Donors use **MetaMask** to make donations, and each donation is recorded as an NFT on the **Polygon blockchain**.
...
- **Smart Contracts**: Written in **Solidity** and deployed on the **Polygon (Matic)** network, managing NFT-based transactions and minting.
...
- **Smart Contracts**: **Solidity** for creating NFT-based smart contracts deployed on the **Polygon (Matic)** blockchain.
- **Blockchain**: **Polygon (Matic)** for secure, low-cost, and scalable transactions.
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/yourusername/donat3.git
   cd donat3
